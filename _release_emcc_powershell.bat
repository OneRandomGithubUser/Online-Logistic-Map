powershell -NoExit Add-Content -path (Get-PSReadlineOption).HistorySavePath 'cls; emcc fftw-3.3.10/libs/libfftw3.a main.cpp -o main.js -s USE_BOOST_HEADERS=1 -std=c++20 -lembind -sALLOW_MEMORY_GROWTH -O3 -sPTHREAD_POOL_SIZE=2 -pthread'
